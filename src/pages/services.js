      ...
      <div className="bg-[#FEEFE6]">
        <div className="max-w-[1600px] m-auto">
          ...
          <div className="px-5 text-center mt-10 mb-12 py-20">
            ...
            <p className="lg:max-w-sm m-auto mt-3 max-w-sm text-black/25">
      ...
      <AppLayout>
        <div className="flex items-center gap-4  mt-24 mb-24  justify-evenly flex-wrap ">
          ...
          <div className="sm:order-first lg:order-last md:order-first px-5">
            <p className=" font-semibold text-[#F9AF82] text-l mb-5">Why we ?</p>
            ...
            <p className="max-w-2xl">
              ...
              easy!  Antsquad&prime;s professionally trained live chat agents will save
              you tons of cash.We&prime;re up to 50x cheaper than hiring a full-time
              employee! The average salary of one full-time customer support agent
              &#40;8 hours a day, 5 days a week&#41; is AED 1,500 to AED 2,500. You can have
              Antsquad staff your live chat support 24/7/365 for as little as
              AED 5,000/month to AED 8,000/month! That means you could save up to $38,000 a year per agent
